...
if selected == "Predictor de Precios": 
    ...
    st.markdown(<h1 class='centered-text-pg1'>Es importante tener claras tus intenciones a la hora de viajar a las islas de Hawaii, ya que dependiendo de si tu viaje es única y exclusivamente por ocio, o si buscas emprender tu propio negocio, los precios van a variar, porque cuando viajas buscas unas reseñas que harán aumentar el precio de tu estancia y en cambio si lo que buscas es emprender tu negocio no tendrá reseñas ya que acaba de comenzar.</h1>, unsafe_allow_html=True) 
